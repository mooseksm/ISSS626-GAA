...
Dropping the classes of highway that comprise \<= 0.5% of total classes of highway:

```{r}
roadsbkk <- roadsbkkinterim %>%
  filter(!(highway %in% c("road","corridor","busway",
...
-   **Occurrences of road accidents in Feb and May seem to generally be decreasing over the years.**
...
-   **Occurrences of road accidents in Apr, Jun, Sep and Oct seem to fluctuate generally around the monthly average across the years.**
...
-   **Occurrences of road accidents in Apr and May seem to fluctuate generally around the monthly average across the years.**
:::
...
Let's first visualise the cleaned *roadacc* data:
...
```{r}
kde_roadacc.bw <- density(roadacc_owin_ppp.km, 
                          sigma=bw.diggle, 
                          edge=TRUE,
                          kernel = "gaussian")
```
