...
![](images/clipboard-2988766549.png){width="507"}
...
### 5.3.4.1 Interim saving as new rds file
...
### 5.3.5 Visualising the cleaned *roadsbkk* data
...
-   service: denotes ways used for vehicle access to a building, parking lot, service station, business estate, beach, campsite etc. they are usually not part of the public street network and may be inaccessible to the general public ([source](https://wiki.openstreetmap.org/wiki/Tag:highway%3Dservice))

-   residential: roads are typically short in length and likely to have lower speed limits and traffic calming measures in place ([source](https://wiki.openstreetmap.org/wiki/Tag:highway%3Dresidential))
...
The number of rows has dropped from 564485 to 41886 rows, which makes the data more manageable.

We take a quick look at the geometry - while there are still a lot of data lines, the plot has cleaned up significantly and we will proceed with this data:
...
### 5.3.6 Checking the geometry of *roadsbkk*
...
### 5.3.7 Re-saving as new rds file
...
## 7. Data Wrangling for Spatial Point Pattern Analysis

### 7.1 Converting data to ppp format for Spatial Point Pattern Analysis
...
### 7.2 Checking for duplicate points
...
### 8.1 Computing KDE using adaptive bandwidth
